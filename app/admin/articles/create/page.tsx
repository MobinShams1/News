    ...
    <div className="max-w-4xl mx-auto space-y-6 dir-rtl">
      <div className="flex items-center justify-between bg-slate-900 p-6 rounded-2xl border border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">تصویر شاخص و مشخصات خبر را مشخص کنید.</p>
        </div>
        <Link
          href="/admin/articles"
      ...
      <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6">
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-2">عنوان خبر *</label>
          <input
            type="text"
            name="title"
            required
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">تصویر شاخص خبر</label>
            <input
              type="file"
              name="imageFile"
              accept="image/*"
        ...
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-2">متن کامل خبر *</label>
          <textarea
            name="content"
            rows={10}
            required
